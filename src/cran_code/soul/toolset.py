...
from cran_code.exception import InvalidToolError, MCPRuntimeError
...
class KimiToolset:
    ...
    def handle(self, tool_call: ToolCall) -> HandleResult:
        ...
        try:
            ...
            async def _call():
                ...
                from cran_code.telemetry import track as _track_tool_call
    ...
    def load_tools(self, tool_paths: list[str], dependencies: dict[type[Any], Any]) -> None:
        """
        Load tools from paths like `cran_code.tools.shell:Shell`.
    ...
    async def load_mcp_tools(
        ...
        from cran_code.mcp_oauth import create_mcp_oauth, has_mcp_oauth_tokens
