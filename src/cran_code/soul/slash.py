...
from cran_code.soul.agent import load_agents_md
from cran_code.soul.context import Context
from cran_code.soul.dynamic_injections.afk_mode import AFK_DISABLED_REMINDER
from cran_code.soul.message import system, system_reminder
from cran_code.utils.export import is_sensitive_file
from cran_code.utils.path import sanitize_cli_path, shorten_home
from cran_code.utils.slashcmd import SlashCommandRegistry
from cran_code.wire.types import StatusUpdate, TextPart
...
async def add_dir(soul: KimiSoul, args: str):
    ...
    from cran_code.utils.path import is_within_directory, list_directory
...
async def export(soul: KimiSoul, args: str):
    ...
    from cran_code.utils.export import perform_export
...
async def import_context(soul: KimiSoul, args: str):
    ...
    from cran_code.utils.export import perform_import
