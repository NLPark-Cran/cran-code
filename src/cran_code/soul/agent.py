...
from cran_code.agentspec import load_agent_spec
from cran_code.approval_runtime import ApprovalRuntime
from cran_code.auth.oauth import OAuthManager
from cran_code.background import BackgroundTaskManager
from cran_code.config import Config
from cran_code.exception import MCPConfigError, SystemPromptTemplateError
from cran_code.llm import LLM
from cran_code.notifications import NotificationManager
...
from cran_code.soul.approval import Approval, ApprovalState
from cran_code.soul.denwarenji import DenwaRenji
from cran_code.soul.toolset import KimiToolset
from cran_code.subagents.models import AgentTypeDefinition, ToolPolicy
from cran_code.subagents.registry import LaborMarket
from cran_code.subagents.store import SubagentStore
from cran_code.utils.environment import Environment
from cran_code.utils.logging import logger
from cran_code.utils.path import find_project_root, is_within_directory, list_directory
from cran_code.wire.root_hub import RootWireHub
...
async def load_agent(
    ...
    *,
    ...
    # Load plugin tools
    from cran_code.plugin.manager import get_plugins_dir
    from cran_code.plugin.tool import load_plugin_tools
