...
from cran_code.tools.display import (
...
from cran_code.utils.typing import flatten_union
...
class ApprovalRequest(BaseModel):
    ...
    # Note that the above fields are just a copy of `cran_code.soul.approval.Request`, but
