...
from cran_code.metadata import WorkDirMeta, load_metadata
from cran_code.session import Session as KimiCLISession
from cran_code.session_state import SessionState, load_session_state, save_session_state
from cran_code.web.models import Session
...
class JointSession(Session):
    ...
    cran_code_session: KimiCLISession = Field(exclude=True)
