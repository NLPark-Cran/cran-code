...
from cran_code.skill.flow import Flow, FlowError
from cran_code.skill.flow.d2 import parse_d2_flowchart
from cran_code.skill.flow.mermaid import parse_mermaid_flowchart
from cran_code.utils.frontmatter import parse_frontmatter
...
def get_builtin_skills_dir() -> Path:
    ...
    if getattr(sys, "frozen", False) and hasattr(sys, "_MEIPASS"):
        ...
        return Path(meipass) / "cran_code" / "skills"
...
def _first_meaningful_line(content: str) -> str | None:
    ...
    :mod:`cran_code.utils.frontmatter`). A malformed frontmatter opener that
    ...
    """
    from cran_code.utils.frontmatter import strip_frontmatter
