...
from cran_code.auth.platforms import get_platform_name_for_provider, refresh_managed_models
from cran_code.cli import Reload, SwitchToVis, SwitchToWeb
from cran_code.config import load_config, save_config
...
from cran_code.ui.shell.mcp_status import render_mcp_console
from cran_code.ui.shell.task_browser import TaskBrowserApp
from cran_code.utils.changelog import CHANGELOG
from cran_code.utils.slashcmd import SlashCommand, SlashCommandRegistry
...
def help(app: Shell, args: str):
    ...
    from cran_code.utils.rich.columns import BulletColumns
...
async def model(app: Shell, args: str):
    ...
    from cran_code.llm import derive_model_capabilities
...
async def editor(app: Shell, args: str):
    ...
    from cran_code.utils.editor import get_editor_command
...
async def feedback(app: Shell, args: str):
    ...
    from cran_code.auth import KIMI_CODE_PLATFORM_ID
    from cran_code.auth.platforms import get_platform_by_id, managed_provider_key
    from cran_code.constant import VERSION
    from cran_code.ui.shell.oauth import current_model_key
    from cran_code.utils.aiohttp import new_client_session
...
async def list_sessions(app: Shell, args: str):
    ...
    from cran_code.ui.shell.session_picker import SessionPickerApp
...
def theme(app: Shell, args: str):
    ...
    from cran_code.ui.theme import get_active_theme
...
async def undo(app: Shell, args: str):
    ...
    from cran_code.session_fork import enumerate_turns, fork_session
