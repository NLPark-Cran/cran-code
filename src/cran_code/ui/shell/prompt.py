...
from cran_code.soul import StatusSnapshot, format_context_status
from cran_code.ui.shell import placeholders as prompt_placeholders
from cran_code.ui.shell.console import console
from cran_code.ui.shell.placeholders import (
    PromptPlaceholderManager,
    normalize_pasted_text,
    sanitize_surrogates,
)
from cran_code.ui.theme import get_prompt_style, get_toolbar_colors
from cran_code.utils.clipboard import (
...
from cran_code.wire.types import ContentPart
...
class LocalFileMentionCompleter(Completer):
    ...
    :mod:`cran_code.utils.file_filter` so that the web backend can reuse
    them.
    """
    ...
    def _get_top_level_paths(self) -> list[str]:
        from cran_code.utils.file_filter import is_ignored
    ...
    def _get_deep_paths(self) -> list[str]:
        from cran_code.utils.file_filter import (
            detect_git,
            git_index_mtime,
            list_files_git,
            list_files_walk,
...
class CustomPromptSession:
    ...
    def _open_in_external_editor(self, event: KeyPressEvent) -> None:
        ...
        from cran_code.utils.editor import edit_text_in_editor, get_editor_command
