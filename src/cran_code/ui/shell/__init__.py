...
from cran_code.background import list_task_views
from cran_code.llm import model_display_name
from cran_code.notifications import NotificationManager, NotificationWatcher
from cran_code.soul import LLMNotSet, LLMNotSupported, MaxStepsReached, RunCancelled, Soul, run_soul
from cran_code.soul.kimisoul import FLOW_COMMAND_PREFIX, KimiSoul
from cran_code.ui.shell import update as _update_mod
from cran_code.ui.shell.console import console
from cran_code.ui.shell.echo import render_user_echo_text
from cran_code.ui.shell.mcp_status import render_mcp_prompt
from cran_code.ui.shell.migration_nudge import print_migration_goodbye
from cran_code.ui.shell.prompt import (
    BgTaskCounts,
    CustomPromptSession,
    CwdLostError,
    PromptMode,
...
from cran_code.ui.shell.replay import replay_recent_history
from cran_code.ui.shell.slash import SKILL_COMMAND_PREFIX, shell_mode_registry
from cran_code.ui.shell.slash import registry as shell_slash_registry
from cran_code.ui.shell.update import LATEST_VERSION_FILE, UpdateResult, do_update, semver_tuple
from cran_code.ui.shell.visualize import (
    ApprovalPromptDelegate,
    visualize,
)
from cran_code.utils.aioqueue import QueueShutDown
from cran_code.utils.envvar import get_env_bool
from cran_code.utils.logging import open_original_stderr
from cran_code.utils.signals import install_sigint_handler
from cran_code.utils.slashcmd import SlashCommand, SlashCommandCall, parse_slash_command_call
from cran_code.utils.subprocess_env import get_clean_env
from cran_code.utils.term import ensure_new_line, ensure_tty_sane
...
class Shell:
    ...
    async def run(self, command: str | None = None) -> bool:
        ...
        if isinstance(self.soul, KimiSoul):
            from cran_code.ui.theme import set_active_theme
        ...
        from cran_code.telemetry import get_sink
        ...
        with CustomPromptSession(
            ...
            try:
                while True:
                    ...
                    from cran_code.ui.shell.visualize import InputAction, classify_input
    ...
    async def _run_slash_command(self, command_call: SlashCommandCall) -> None:
        from cran_code.cli import Reload, SwitchToVis, SwitchToWeb
        from cran_code.telemetry import track
    ...
    async def _run_btw_modal(
        ...
        """
        from cran_code.soul.btw import execute_side_question
        from cran_code.ui.shell.visualize import (
...
def _print_welcome_info(name: str, info_items: list[WelcomeInfoItem]) -> None:
    ...
    if LATEST_VERSION_FILE.exists():
        from cran_code.constant import VERSION as current_version
        from cran_code.ui.shell.update import SKIPPED_VERSION_FILE
        from cran_code.utils.envvar import get_env_bool
