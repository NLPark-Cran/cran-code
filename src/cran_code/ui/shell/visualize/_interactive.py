...
from cran_code.ui.shell.console import console, render_to_ansi
from cran_code.ui.shell.echo import render_user_echo_text
from cran_code.ui.shell.keyboard import KeyEvent
from cran_code.ui.shell.prompt import (
    CustomPromptSession,
    UserInput,
)
from cran_code.ui.shell.visualize._btw_panel import _BtwModalDelegate
from cran_code.ui.shell.visualize._input_router import InputAction, classify_input
    ...
    def handle_local_input(self, user_input: UserInput) -> None:
        ...
        match action.kind:
            ...
            case InputAction.QUEUE:
                ...
                from cran_code.utils.slashcmd import parse_slash_command_call

                if cmd := parse_slash_command_call(user_input.resolved_command.strip()):
                    from cran_code.ui.shell.slash import registry as shell_registry

                    if shell_registry.find_command(cmd.name) is not None:
                        from cran_code.ui.shell.prompt import toast
