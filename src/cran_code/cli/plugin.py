...
def install_cmd(
    ...
    from cran_code.plugin.manager import get_plugins_dir, install_plugin
    ...
    try:
        ...
        from cran_code.plugin.manager import collect_host_values
...
def list_cmd() -> None:
    ...
    from cran_code.plugin.manager import get_plugins_dir, list_plugins
...
def remove_cmd(
    ...
    from cran_code.plugin.manager import get_plugins_dir, remove_plugin
...
def info_cmd(
    ...
    """Show plugin details."""
    from cran_code.plugin import parse_plugin_json
