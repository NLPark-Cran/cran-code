...
class LazySubcommandGroup(typer.core.TyperGroup):
    ...
    lazy_subcommands: dict[str, tuple[str, str, str]] = {
        "info": ("cran_code.cli.info", "cli", "Show version and protocol information."),
        "export": ("cran_code.cli.export", "cli", "Export session data."),
        "mcp": ("cran_code.cli.mcp", "cli", "Manage MCP server configurations."),
        "plugin": ("cran_code.cli.plugin", "cli", "Manage plugins."),
        "vis": ("cran_code.cli.vis", "cli", "Run Cran Agent Tracing Visualizer."),
        "web": ("cran_code.cli.web", "cli", "Run Cran Code CLI web interface."),
    }
