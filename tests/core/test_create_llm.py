...
def test_augment_provider_with_env_vars_kimi(monkeypatch):
    ...
    # Cran Code reads CRAN_* env overrides for the kimi provider (fork rename).
    monkeypatch.setenv("CRAN_BASE_URL", "https://env.test/v1")
    monkeypatch.setenv("CRAN_API_KEY", "env-key")
    monkeypatch.setenv("CRAN_MODEL_NAME", "kimi-env-model")
