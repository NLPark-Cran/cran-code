...
from cran_code.wire.serde import deserialize_wire_message, serialize_wire_message
...
def test_wire_message_type_alias():
    import cran_code.wire.types

    module = cran_code.wire.types
    # Helper types that are BaseModel subclasses but not WireMessage types
    from cran_code.wire.types import HookResponse
