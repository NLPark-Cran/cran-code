...
from cran_code.agentspec import DEFAULT_AGENT_FILE, load_agent_spec
from cran_code.exception import AgentSpecError
...
def test_load_default_agent_spec():
    ...
    assert spec.tools == snapshot(
        [
            "cran_code.tools.agent:Agent",
            "cran_code.tools.ask_user:AskUserQuestion",
            "cran_code.tools.todo:SetTodoList",
            "cran_code.tools.shell:Shell",
            "cran_code.tools.background:TaskList",
            "cran_code.tools.background:TaskOutput",
            "cran_code.tools.background:TaskStop",
...
def test_load_agent_spec_basic(agent_file: Path):
    ...
    assert spec.tools == snapshot(["cran_code.tools.think:Think"])
...
def test_load_agent_spec_with_exclude_tools(agent_file_with_tools: Path):
    ...
    assert spec.tools == snapshot(["cran_code.tools.think:Think", "cran_code.tools.shell:Shell"])
    assert spec.exclude_tools == snapshot(["cran_code.tools.shell:Shell"])
...
agent:
  ...
  tools: ["cran_code.tools.think:Think"]
""")
...
agent:
  name: "Test Agent"
  system_prompt_path: ./system.md
  tools: ["cran_code.tools.think:Think", "cran_code.tools.shell:Shell"]
  exclude_tools: ["cran_code.tools.shell:Shell"]
""")
