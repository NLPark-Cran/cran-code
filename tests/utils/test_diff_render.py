"""Tests for cran_code.utils.rich.diff_render — unified diff rendering."""
...
from cran_code.tools.display import DiffDisplayBlock
from cran_code.utils.diff import _build_diff_blocks_sync as build_diff_blocks
...
class TestHighlightHunk:
    ...
    def test_inline_diff_with_tabs(self) -> None:
        ...
        from cran_code.utils.rich.diff_render import get_diff_colors
