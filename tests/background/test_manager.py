...
from cran_code.approval_runtime import ApprovalRequestRecord, ApprovalRuntimeEvent, ApprovalSource
from cran_code.background import TaskRuntime, TaskSpec
from cran_code.background.agent_runner import BackgroundAgentRunner
from cran_code.notifications import NotificationDelivery, NotificationEvent, NotificationView
...
async def test_create_agent_task_persists_timeout_s_on_spec(runtime, monkeypatch):
    ...
    monkeypatch.setattr("cran_code.background.agent_runner.BackgroundAgentRunner.run", _noop)
