...
from cran_code.auth.oauth import _ascii_header_value, _common_headers
...
class TestCommonHeaders:
    ...
    @patch("cran_code.auth.oauth.platform")
    @patch("cran_code.auth.oauth.get_device_id", return_value="abc123")
