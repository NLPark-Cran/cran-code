...
from cran_code.wire.types import ApprovalRequest, ApprovalResponse, QuestionRequest, StatusUpdate
...
async def test_render_agent_status_excludes_panels_in_interactive() -> None:
    ...
    from cran_code.ui.shell.visualize import _PromptLiveView
...
async def test_shell_external_approval_response_syncs_modal(
    ...
    from cran_code.approval_runtime import ApprovalSource
    from cran_code.soul.agent import Agent
