...
from cran_code.tools.shell import Params, Shell
from cran_code.tools.utils import DEFAULT_MAX_CHARS
...
async def test_timeout_parameter_validation_bounds(shell_tool: Shell):
    ...
    from cran_code.tools.shell import MAX_BACKGROUND_TIMEOUT, MAX_FOREGROUND_TIMEOUT
...
def _capture_exec(monkeypatch: pytest.MonkeyPatch) -> list[str]:
    ...
    monkeypatch.setattr("cran_code.tools.shell.kaos.exec", fake_exec)
    return captured
