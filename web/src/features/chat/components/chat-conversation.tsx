      ...
      {shouldShowEmptyState ? (
        isLoadingResponse ? (
          <ConversationEmptyState
            ...
            title={isStartingEnvironment ? t("chat:startingEnvironment") : t("chat:connectingToSession")}
          />
        ) : emptyNoSessionState ? (
          <ConversationEmptyState>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <span>{t("chat:createNewSession")}</span>
                  </Button>
                </TooltipTrigger>
                <TooltipContent className="flex flex-col items-center gap-1" side="top">
                  ...
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    <span>{t("chat:openInNewTab", { modifier: newSessionShortcutModifier })}</span>
                  </div>
                </TooltipContent>
              </Tooltip>
            ) : null}
